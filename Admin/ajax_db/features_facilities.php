...
if(isset($_POST['get_features']))
{
  ...
  while($row=mysqli_fetch_assoc($res)){
    ...
    <td>$row[name]</td>
    <td>
    <button type="button" onclick="rem_feature($row[id])" class="btn btn-danger btn-sm">
...
if(isset($_POST['rem_facility']))
{
  ...
  if(deleteImage($img['icon'],FACILITIES_FOLDER)){ //katmm7i tswira mn lpc tahowa bach may3mrch
