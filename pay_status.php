        ...
        <div class="container">
            <div class="row ">
                ...
                <?php
                 ...
                 $booking_q="SELECT bo.*, bd.* FROM `booking_order` bo INNER JOIN `booking_details` bd ON bo.booking_id=
                 bd.booking_id WHERE bo.order_id=? AND bo.user_id=? AND bo.booking_status!=?";
                       ...
                       <div class="col-12 px-4">
                         <p class="fw-bold alert alert-success">
                           <i class="bi bi-check-circle-fill"></i>
                            payement done ! booking successful.
                           <br><br>
                    ...
                    <div class="col-12 px-4">
                      <p class="fw-bold alert alert-danger">
                        <i class="bi bi-exclamation-traingle-fill"></i>
                         payement failed ! $booking_fetch[trans_resp_msg]
                        <br><br>
                        <a href='bookings.php'>go to bookings</a>
                      </p>
                   </div>
